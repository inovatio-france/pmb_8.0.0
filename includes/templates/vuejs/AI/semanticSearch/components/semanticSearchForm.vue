...
export default {
    ...
    created() {
        if (0 !== this.semanticsearch.id_ai_setting) {
            ...
            this.data.settings.prompt_system = `À partir de la liste de notice, répond en {{ user.language }} à la question de l'utilisateur.
...
{% endfor %}`;
            ...
            this.data.settings.prompt_user = `Question : {{ user.query }}`;
        }
    },
    mounted() {
