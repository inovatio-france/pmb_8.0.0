...
// +-------------------------------------------------+
// $Id: pmbesClean.class.php,v 1.59.2.1 2024/05/23 13:15:52 dgoron Exp $
		...
		if (SESSrights & ADMINISTRATION_AUTH) {
			...
			if(static::$indexation_by_fields) {
			    ...
			    while ($row = pmb_mysql_fetch_object($result)) {
			        $indexation_authperso = new indexation_authpersos($include_path."/indexation/authorities/authperso/champs_base.xml", "authorities", (1000+$row->id_authperso), $row->id_authperso);
			        $indexation_authperso->launch_indexation();
			    }
			} else {
