...
// +-------------------------------------------------+
// $Id: ajax_main.inc.php,v 1.20.2.1 2024/08/08 08:07:53 dgoron Exp $
        ...
        switch($action) {
            case "list":
                ...
                if ($id_proc) {
                    ...
                    list_query_proc_ui::set_id_proc($id_proc);
                    procs_edition_controller::set_list_ui_class_name('list_query_proc_ui');
